    ...
    for i in data:
        ...
        if find_domain(dom, lutfile) == False:
            ...
            for key in i[source].keys():
                ...
                plt.errorbar(x=float(key), y=res, yerr=i[source][key]["err_res"], fmt='o', color='b', ecolor='red',
                             capsize=5)
            if source == "60Co":
                plt.xlim([1000., 1400.])
            elif source == "152Eu":
            ...
            for key in i[source].keys():
                ...
                plt.errorbar(x=float(key), y=eff, yerr=i[source][key]["err_eff"], fmt='o', color='b', ecolor='red',
                             capsize=5)
